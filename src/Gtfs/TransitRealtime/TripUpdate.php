 ...
 * Note that the feed provider is allowed, but not , to purge past
...
class TripUpdate extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .transit_realtime.VehicleDescriptor vehicle = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional uint64 timestamp = 4;</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional int32 delay = 5;</code>
     */
     ...
     *           Additional information on the vehicle that is serving this trip.
     *     @type array<\Transit_realtime\TripUpdate\StopTimeUpdate>|\Google\Protobuf\Internal\RepeatedField $stop_time_update
     *           Updates to StopTimes for the trip (both future, i.e., predictions, and in
     *           some cases, past ones, i.e., those that already happened).
     *           The updates must be sorted by stop_sequence, and apply for all the
     *           following stops of the trip up to the next specified one.
     ...
     *
     * Generated from protobuf field <code>repeated .transit_realtime.TripUpdate.StopTimeUpdate stop_time_update = 2;</code>
     * @param array<\Transit_realtime\TripUpdate\StopTimeUpdate>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
