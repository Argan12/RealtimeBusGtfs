...
class Alert extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .transit_realtime.EntitySelector informed_entity = 4;</code>
     */
    private $informed_entity;
    /**
     * Generated from protobuf field <code>optional .transit_realtime.Alert.Cause cause = 5;</code>
     */
    protected $cause = null;
    /**
     * Generated from protobuf field <code>optional .transit_realtime.Alert.Effect effect = 6;</code>
     */
     ...
     *
     *     @type array<\Transit_realtime\TimeRange>|\Google\Protobuf\Internal\RepeatedField $active_period
     *           Time when the alert should be shown to the user. If missing, the
     *           alert will be shown as long as it appears in the feed.
     *           If multiple ranges are given, the alert will be shown during all of them.
     *     @type array<\Transit_realtime\EntitySelector>|\Google\Protobuf\Internal\RepeatedField $informed_entity
     *           Entities whose users we should notify of this alert.
     *     @type int $cause
     *     @type int $effect
     ...
     *
     * Generated from protobuf field <code>repeated .transit_realtime.TimeRange active_period = 1;</code>
     * @param array<\Transit_realtime\TimeRange>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .transit_realtime.EntitySelector informed_entity = 4;</code>
     * @param array<\Transit_realtime\EntitySelector>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
